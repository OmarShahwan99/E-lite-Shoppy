      ...
      <div className="container flex flex-wrap gap-8 justify-center">
        {FEATURES.map((feature) => (
          <div className="flex gap-4 group" key={feature.title}>
            <div className="flex justify-center items-center bg-dark text-light p-7 relative overflow-hidden before:absolute before:w-0 before:h-0 before:bg-primary before:top-0 before:left-0 before:transition-all before:duration-200 group-hover:before:w-full group-hover:before:h-full">
              <FontAwesomeIcon
