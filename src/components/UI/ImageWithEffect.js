...
const ImageWithEffect = (props) => {
  return (
    <div className="relative overflow-hidden group h-full">
      <Overlay className="absolute z-10 p-20 xl:p-24 before:absolute before:border-light before:border-4 before:w-4/5 before:h-2/3 before:top-10 before:left-12 before:opacity-0 before:-translate-x-10 group hover:before:translate-x-0 hover:before:opacity-100 before:transition-all before:duration-300">
